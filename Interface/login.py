...
forgotButton = Button(loginWindow, text='Forgot Password?', bd=0, cursor='hand2',
                      activebackground='NavajoWhite3', activeforeground='brown1', bg='NavajoWhite3', font=('Arial Sans', 8, 'bold'))
forgotButton.place(x=680, y=390)

loginButton = Button(loginWindow, text='Login', font=('Arial Sans', 8, 'bold'), fg='white', cursor='hand2',
                     bg='brown1', height=2, width=25, activebackground='brown1', activeforeground='white')
